<?php
    ...
    <head>
        ...
        <link href="../css/communication.css?v=<?php echo time(); ?>" rel="stylesheet" type="text/css" />
    </head>
            ...
            <div class="main">
                ...
                <div class="footer">
                    <div class="emailAddress">
                        ...
                        <p>Εναλλακτικά μπορείτε να αποστείλετε e-mail στην παρακάτω διεύθυνση ηλεκτρονικού ταχυδρομείου <a class="mailto" href="mailto:tutor@csd.auth.test.gr">tutor@csd.auth.test.gr</a> </p>
                    </div>
            </div>
            </div>
        </div>
