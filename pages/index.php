        ...
        <div class="container">
            ...
            <div class="main">
                <ul class="homeMainText">
                    ...
                    <li>Στην σελίδα <strong><a class="index-link" href="announcement.html">Ανακοινώσεις</a></strong>
                        βρίσκονται όλα τα νεα σχετικά με το μάθημα.</li>
                    <li>Στην σελίδα <strong><a class="index-link" href="communication.html">Επικοινωνία</a></strong>
                        βρίσκονται τα στοιχεία επικοινωνίας του διδάσκοντα.</li>
                    <li>Στην σελίδα <strong><a class="index-link" href="documents.html">Έγγραφα Μαθήματος</a></strong>
                        Μαθήματος βρίσκεται το περιεχόμενο του μαθήματος.</li>
                    <li>Στην σελίδα <strong><a class="index-link" href="homework.html">Εργασίες</a></strong> αναρτώνται οι
